...
const testimonials = [
  {
    quote:
      "Beko bana bu ürünü önerdi, sonra iki saat boyunca neden böyle harika olduğunu anlattı. Artık hem sağlıklıyım hem de Beko'dan kaçıyorum. İki taş bir kuş!",
    author: "Mehmet Ç.",
    role: "Beko'nun komşusu",
    avatar: "/placeholder.svg?height=80&width=80",
  },
  {
    quote:
      "Beko ile bir gün geçirince, vitaminin gereksiz olduğunu anladım. Adam o kadar enerjik ki, yanında 5 dakika dursan 10 yıl genç hissediyorsun!",
    author: "Ayşe K.",
    role: "Beko'nun eski arkadaşı",
    avatar: "/placeholder.svg?height=80&width=80",
  },
  {
    quote:
      "Doktor olarak söylüyorum: Beko'nun tavsiye ettiği şeyleri dinlemeyin. Ama bu ürün gerçekten işe yarıyor, o yüzden kafam karıştı. Belki de Beko bir dahi?",
    author: "Dr. Zeynep A.",
    role: "Beko'nun doktoru (mecburen)",
    avatar: "/placeholder.svg?height=80&width=80",
  },
  {
    quote: "Beko'nun bu ürünü tavsiye etmesinden önce normal bir hayatım vardı. Şimdi her sabah 6'da kalkıp koşuyorum. Beko ne yaptı bana!?",
    author: "Mustafa Y.",
    role: "Eski tembel insan",
    avatar: "/placeholder.svg?height=80&width=80",
  },
  {
    quote: "Beko'nun evine gittim, buzdolabında sadece bu ürün ve ayran vardı. 'Sen gerçek misin?' diye sordum. Hala cevap beklemedim.",
    author: "Fatma S.",
    role: "Endişeli kuzen",
    avatar: "/placeholder.svg?height=80&width=80",
  },
      ...
      <div className="w-full">
        <div className="text-center mb-16 lg:mb-20 px-6">
          <p className="reveal opacity-0 text-sm uppercase tracking-[0.2em] text-secondary font-medium mb-4">
            Pure Glow Hikayeleri
          </p>
          <ScrollBlurText
            text="Doğal ışıltılarını keşfettiler"
